...
const Tools: Tool[] = [
  ...
  },
  {
    id: 113,
    title: "Mixo",
    description: 'AI-powered builder helps entrepreneurs quickly launch and validate their business ideas',
    image: './images/others/mixo.png',
    website: 'https://mixo.io/?via=deeintech',
    price: 9,
    tags: ['others'],
  },
  {
    id: 114,
    title: "Murf",
    description: 'AI voice generator for podcasts, videos, and professional presentations',
    image: './images/voice/murf.png',
    website: 'https://mixo.io/?via=deeintech',
    price: 19,
    tags: ['voice'],
  },
  {
    id: 115,
    title: "Raycast",
    description: 'AI assistant that unlocks the power of AI on your Mac',
    image: './images/others/raycast.png',
    website: 'https://www.raycast.com/ai',
    price: -1,
    tags: ['assistant', 'waitlist'],
  },
  {
    id: 116,
    title: "Uizard",
    description: 'AI tool for designing mobile apps, websites, wireframes, prototypes in minutes',
    image: './images/marketing/uizard.png',
    website: 'https://uizard.io/',
    price: 0,
    tags: ['marketing', 'art', 'freeplan'],
  },
  {
    id: 117,
    title: "Pebblely",
  ...
  },
  {
    id: 118,
    title: "Offeo",
    description: 'AI-powered online video ad maker that creates amazing content in less than 3 minutes',
    image: './images/video/offeo.png',
    website: 'https://offeo.com/ltd?ref=deeintech',
    price: 19,
  ...
  },
  {
    id: 119,
    title: "Galileo",
    description: 'AI tool for creating delightful, editable UI designs from a simple text description',
    image: './images/marketing/galileo.png',
